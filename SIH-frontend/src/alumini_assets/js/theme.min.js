...
jQuery(document).ready(function(e) {
  e("#off-canvas").length > 0 &&
    (e(".navbar-nav")
      .clone()
      .prependTo("#off-canvas .offcanvaswrap_menus"),
    e(function() {
      e(document).trigger("enhance");
    }),
    e(document.body).addClass("offcanvas-added")),
    e(".slider-active-wrap").owlCarousel({
      items: 1,
      loop: !0,
      nav: !1,
      autoplay: !1,
    ...
    e(".funfact-count").counterUp({ delay: 50, time: 1e3 }),
    e(".gallery-gird").isotope(),
    e(".gallery-menu span").on("click", function() {
    ...
    e(".smooth-scroll").smoothScroll({ speed: 1e3, easing: "jswing" }),
    ...
    submitHandler: function(a) {
      ...
      return (
        e.ajax({
          ...
          success: function(a) {
            try {
              (a = e.parseJSON(a)).error
                ? e.each(a.error_field, function(s) {
                    0 == e("label#" + a.error_field[s] + "-error").length &&
                      e("#" + a.error_field[s]).after(
                      ...
                      e("label#" + a.error_field[s] + "-error").text(
                        a.message[a.error_field[s]]
                      );
                  })
                : a.successmessage &&
                  (e("#cbx-formalert")
                    .addClass("alert alert alert-success")
                    .html(a.successmessage),
                  s[0].reset());
            } catch (e) {
              s[0].reset();
            }
  ...
  e("form#cbx-subscribe-form").on("submit", function(a) {
    ...
    e.ajax({
      ...
      success: function(a) {
        try {
          if ((a = e.parseJSON(a)).error)
            throw (r.removeAttr("style"), a.message);
          r.css("color", "#0f0");
        } catch (e) {}
      },
      error: function(e) {}
